...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dapoxplain Housing Services — Bespoke Ultra-Luxury Real Estate" },
      { property: "og:description", content: "DHS curates the world's most extraordinary residences — private estates, penthouses and villas for an exceptional clientele." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Dapoxplain Housing Services — Bespoke Ultra-Luxury Real Estate" },
      { name: "twitter:description", content: "DHS curates the world's most extraordinary residences — private estates, penthouses and villas for an exceptional clientele." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/a1494670-e75c-4b67-a49c-0c9a205b0e7a" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/a1494670-e75c-4b67-a49c-0c9a205b0e7a" },
    ],
    links: [
